...
| HT_REPORTING_OPA_CERT_FILE | Certificate file containing the CA to verify the server's certificate. This is for private certificates. If this is set then `endpoint` above should use `https` as the protocol. |
