...
func (x *AgentConfig) loadFromEnv(prefix string, defaultValues *AgentConfig) {
	...
	} else if len(x.PropagationFormats) == 0 && defaultValues != nil && defaultValues.PropagationFormats != nil && len(defaultValues.PropagationFormats) > 0 {
...
func (x *DataCapture) loadFromEnv(prefix string, defaultValues *DataCapture) {
	...
	} else if len(x.AllowedContentTypes) == 0 && defaultValues != nil && defaultValues.AllowedContentTypes != nil && len(defaultValues.AllowedContentTypes) > 0 {
