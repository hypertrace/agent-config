...
const (
	...
	SpanProcessorType_SPAN_PROCESSOR_TYPE_BATCH       SpanProcessorType = 1
	SpanProcessorType_SPAN_PROCESSOR_TYPE_SIMPLE      SpanProcessorType = 2
)
...
var (
	SpanProcessorType_name = map[int32]string{
		...
		1: "SPAN_PROCESSOR_TYPE_BATCH",
		2: "SPAN_PROCESSOR_TYPE_SIMPLE",
	}
...
func (LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_hypertrace_agent_config_v1_config_proto_enumTypes[4].Descriptor()
}

func (LogLevel) Type() protoreflect.EnumType {
	return &file_hypertrace_agent_config_v1_config_proto_enumTypes[4]
}
...
func (CompressionType) Descriptor() protoreflect.EnumDescriptor {
	return file_hypertrace_agent_config_v1_config_proto_enumTypes[5].Descriptor()
}

func (CompressionType) Type() protoreflect.EnumType {
	return &file_hypertrace_agent_config_v1_config_proto_enumTypes[5]
}
...
type Reporting struct {
	...
	// Compression type
	CompressionType CompressionType `protobuf:"varint,10,opt,name=compression_type,json=compressionType,proto3,enum=hypertrace.agent.config.v1.CompressionType" json:"compression_type,omitempty"`
	// Span Processor type
	SpanProcessorType SpanProcessorType `protobuf:"varint,11,opt,name=span_processor_type,json=spanProcessorType,proto3,enum=hypertrace.agent.config.v1.SpanProcessorType" json:"span_processor_type,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Reporting) GetCompressionType() CompressionType {
	if x != nil {
...
var file_hypertrace_agent_config_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_hypertrace_agent_config_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_hypertrace_agent_config_v1_config_proto_goTypes = []any{
	...
	(SpanProcessorType)(0),         // 2: hypertrace.agent.config.v1.SpanProcessorType
	(MetricReporterType)(0),        // 3: hypertrace.agent.config.v1.MetricReporterType
	(LogLevel)(0),                  // 4: hypertrace.agent.config.v1.LogLevel
	(CompressionType)(0),           // 5: hypertrace.agent.config.v1.CompressionType
	(*AgentConfig)(nil),            // 6: hypertrace.agent.config.v1.AgentConfig
	(*Reporting)(nil),              // 7: hypertrace.agent.config.v1.Reporting
	(*Message)(nil),                // 8: hypertrace.agent.config.v1.Message
	(*DataCapture)(nil),            // 9: hypertrace.agent.config.v1.DataCapture
	(*JavaAgent)(nil),              // 10: hypertrace.agent.config.v1.JavaAgent
	(*GoAgent)(nil),                // 11: hypertrace.agent.config.v1.GoAgent
	(*Telemetry)(nil),              // 12: hypertrace.agent.config.v1.Telemetry
	(*LogsExport)(nil),             // 13: hypertrace.agent.config.v1.LogsExport
	nil,                            // 14: hypertrace.agent.config.v1.AgentConfig.ResourceAttributesEntry
...
var file_hypertrace_agent_config_v1_config_proto_depIdxs = []int32{
	15, // 0: hypertrace.agent.config.v1.AgentConfig.service_name:type_name -> google.protobuf.StringValue
	7,  // 1: hypertrace.agent.config.v1.AgentConfig.reporting:type_name -> hypertrace.agent.config.v1.Reporting
	9,  // 2: hypertrace.agent.config.v1.AgentConfig.data_capture:type_name -> hypertrace.agent.config.v1.DataCapture
	0,  // 3: hypertrace.agent.config.v1.AgentConfig.propagation_formats:type_name -> hypertrace.agent.config.v1.PropagationFormat
	16, // 4: hypertrace.agent.config.v1.AgentConfig.enabled:type_name -> google.protobuf.BoolValue
	10, // 5: hypertrace.agent.config.v1.AgentConfig.javaagent:type_name -> hypertrace.agent.config.v1.JavaAgent
	14, // 6: hypertrace.agent.config.v1.AgentConfig.resource_attributes:type_name -> hypertrace.agent.config.v1.AgentConfig.ResourceAttributesEntry
	12, // 7: hypertrace.agent.config.v1.AgentConfig.telemetry:type_name -> hypertrace.agent.config.v1.Telemetry
	11, // 8: hypertrace.agent.config.v1.AgentConfig.goagent:type_name -> hypertrace.agent.config.v1.GoAgent
	15, // 9: hypertrace.agent.config.v1.Reporting.endpoint:type_name -> google.protobuf.StringValue
	16, // 10: hypertrace.agent.config.v1.Reporting.secure:type_name -> google.protobuf.BoolValue
	15, // 11: hypertrace.agent.config.v1.Reporting.token:type_name -> google.protobuf.StringValue
	1,  // 12: hypertrace.agent.config.v1.Reporting.trace_reporter_type:type_name -> hypertrace.agent.config.v1.TraceReporterType
	15, // 13: hypertrace.agent.config.v1.Reporting.cert_file:type_name -> google.protobuf.StringValue
	15, // 14: hypertrace.agent.config.v1.Reporting.metric_endpoint:type_name -> google.protobuf.StringValue
	3,  // 15: hypertrace.agent.config.v1.Reporting.metric_reporter_type:type_name -> hypertrace.agent.config.v1.MetricReporterType
	16, // 16: hypertrace.agent.config.v1.Reporting.enable_grpc_loadbalancing:type_name -> google.protobuf.BoolValue
	5,  // 17: hypertrace.agent.config.v1.Reporting.compression_type:type_name -> hypertrace.agent.config.v1.CompressionType
	2,  // 18: hypertrace.agent.config.v1.Reporting.span_processor_type:type_name -> hypertrace.agent.config.v1.SpanProcessorType
	16, // 19: hypertrace.agent.config.v1.Message.request:type_name -> google.protobuf.BoolValue
	16, // 20: hypertrace.agent.config.v1.Message.response:type_name -> google.protobuf.BoolValue
	8,  // 21: hypertrace.agent.config.v1.DataCapture.http_headers:type_name -> hypertrace.agent.config.v1.Message
	8,  // 22: hypertrace.agent.config.v1.DataCapture.http_body:type_name -> hypertrace.agent.config.v1.Message
	8,  // 23: hypertrace.agent.config.v1.DataCapture.rpc_metadata:type_name -> hypertrace.agent.config.v1.Message
	8,  // 24: hypertrace.agent.config.v1.DataCapture.rpc_body:type_name -> hypertrace.agent.config.v1.Message
	17, // 25: hypertrace.agent.config.v1.DataCapture.body_max_size_bytes:type_name -> google.protobuf.Int32Value
	17, // 26: hypertrace.agent.config.v1.DataCapture.body_max_processing_size_bytes:type_name -> google.protobuf.Int32Value
	15, // 27: hypertrace.agent.config.v1.DataCapture.allowed_content_types:type_name -> google.protobuf.StringValue
	15, // 28: hypertrace.agent.config.v1.JavaAgent.filter_jar_paths:type_name -> google.protobuf.StringValue
	16, // 29: hypertrace.agent.config.v1.GoAgent.use_custom_bsp:type_name -> google.protobuf.BoolValue
	16, // 30: hypertrace.agent.config.v1.Telemetry.startup_span_enabled:type_name -> google.protobuf.BoolValue
	16, // 31: hypertrace.agent.config.v1.Telemetry.metrics_enabled:type_name -> google.protobuf.BoolValue
	13, // 32: hypertrace.agent.config.v1.Telemetry.logs:type_name -> hypertrace.agent.config.v1.LogsExport
	16, // 33: hypertrace.agent.config.v1.LogsExport.enabled:type_name -> google.protobuf.BoolValue
	4,  // 34: hypertrace.agent.config.v1.LogsExport.level:type_name -> hypertrace.agent.config.v1.LogLevel
